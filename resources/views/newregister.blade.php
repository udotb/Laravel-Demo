                    ...
                    <div class="p-5">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="user">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control form-control-user" form-control-user name="password_confirmation" required autocomplete="new-password">
                                </div>
                            </div>
